...
func _ready():
	...
	player_hp = Globals.player_health
	player_max_hp = Globals.player_health
	player_atk = Globals.player_attack
	
	enemy_name = Globals.current_enemy_name
	enemy_hp = Globals.current_enemy_health
	enemy_max_hp = Globals.current_enemy_health
	enemy_atk = Globals.current_enemy_attack
...
func shake_sprite(sprite: Node2D):
